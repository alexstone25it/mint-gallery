...
class FlipCard extends Component {
  render() {
    ...
    return this.props.showCaseData.map((_, index) => (
      <div
        className={getFrontClasses(this.props.showCaseData[index].id)}
        key={this.props.showCaseData[index].id}
      >
        <img
          className={styles.img}
          src={`${this.props.showCaseData[index].src}.jpg`}
          alt={this.props.showCaseData[index].alt}
        />

        <div className={getBackClasses(this.props.showCaseData[index].id)}>
